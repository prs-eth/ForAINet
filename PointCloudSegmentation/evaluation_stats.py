...
if __name__ == '__main__':
    ...
    # Initialize...
    LOG_FOUT = open('/cluster/work/igp_psr/binbin/OutdoorPanopticSeg_V2/backup/pointgroup_treeins/eval/2023-03-14_09-35-55/evaluation_total2.txt', 'a')  # @Treeins: save evaluation file with name output_file_name
    ...
    test_sem_path = '/cluster/work/igp_psr/binbin/OutdoorPanopticSeg_V2/backup/pointgroup_treeins/eval/2023-03-14_09-35-55'
    ...
    test_ins_list = sorted(glob.glob(test_sem_path + '/Instance_Embed_results_forEval*.ply', recursive=False), key=lambda name:int(name[32+len(test_sem_path):-4]))
