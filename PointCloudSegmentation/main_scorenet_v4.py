...
parser.add_argument('--model_name', type=str, default='MinkUNet34')
...
class SetResNet(torch.nn.Module):
    def __init__(self): #,independent=False):
        ...
        #new scorenet
        self.backbone = MinkUNet34(in_channels=16, out_channels=1, D=3)#ResNet18(in_channels=16, out_channels=1, D=3)
