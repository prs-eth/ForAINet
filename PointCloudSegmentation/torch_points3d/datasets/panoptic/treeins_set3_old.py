...
from torch_points3d.datasets.segmentation.treeins_set3 import TreeinsSphere, TreeinsCylinder, INV_OBJECT_LABEL
...
SemIDforInstance = np.array([1,2])  # only class tree/1 is is a semantic class with instances, namely tree instances. In contrast, semantic class non-tree is a stuff class.
