...
from torch_points3d.datasets.segmentation.treeins_set2 import TreeinsSphere, TreeinsCylinder, INV_OBJECT_LABEL
...
SemIDforInstance = np.array([1,2,3])  # only class tree/1 is is a semantic class with instances, namely tree instances. In contrast, semantic class non-tree is a stuff class.
...
def final_eval(pre_sem, pre_ins_offset, pos, gt_sem, gt_ins, output_file_name):
    ...
    NUM_CLASSES_sem = 5
    NUM_CLASSES_count = 4  # @Treeins: 2 classes without unclassified
