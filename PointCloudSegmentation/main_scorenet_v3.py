...
parser.add_argument('--model_name', type=str, default='MinkUNet18')
...
class SetResNet(torch.nn.Module):
    def __init__(self): #,independent=False):
        ...
        #new scorenet
        self.backbone = MinkUNet18(in_channels=16, out_channels=1, D=3)#ResNet18(in_channels=16, out_channels=1, D=3)
